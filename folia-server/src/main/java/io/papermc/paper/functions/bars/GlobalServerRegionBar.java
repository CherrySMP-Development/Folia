package io.papermc.paper.functions.bars;
...
import io.papermc.paper.config.modules.function.RegionBarConfig;
import io.papermc.paper.enums.EnumStatusBarDisplay;
...
public class GlobalServerRegionBar extends AbstractGlobalServerBar {
    ...
    public boolean isPlayerVisible(Player player) {
        return player.getPersistentDataContainer().getOrDefault(new org.bukkit.NamespacedKey("paper", "bar_visible_" + this.getClass().getSimpleName()), org.bukkit.persistence.PersistentDataType.BOOLEAN, false) && super.isPlayerVisible(player);
    }

    public void setVisibilityForPlayer(Player target, boolean canSee) {
        target.getPersistentDataContainer().set(new org.bukkit.NamespacedKey("paper", "bar_visible_" + this.getClass().getSimpleName()), org.bukkit.persistence.PersistentDataType.BOOLEAN, canSee);
    }
